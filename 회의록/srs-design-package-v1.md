...
작성일: 2026-05-11
관련 강의 주차: Week 3 (요구공학) · Week 4 (시스템 모델링 / 유스케이스)
...
**[FIGURE 1: 시스템 컨텍스트 다이어그램 — `diagram-system-context.svg`]**
...
**[FIGURE 2: 유스케이스 다이어그램 — `diagram-usecase.svg`]**
